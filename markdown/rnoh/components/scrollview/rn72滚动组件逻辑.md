...
> **适用范围：本文只对应鸿蒙 RN 0.72 分支源码快照**：`0.72-main` / `3718509b4`，`react-native 0.72.5`，`react-native-harmony 0.72.141`。  
> 高版本 RNOH / ArkUI ScrollView 可能已经重构或调整实现细节，排查时请以对应分支源码为准。  
